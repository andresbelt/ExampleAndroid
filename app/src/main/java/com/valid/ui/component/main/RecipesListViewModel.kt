...
constructor(private val recipesDataUseCase: getTopArtistUseCase) : BaseViewModel() {
    ...
    private val tracksPrivate = MutableLiveData<Event<ResponseGetTopTracks>>()
    ...
    fun openTracks(recipesItem: ResponseGetTopTracks) {
        tracksPrivate.value = Event(recipesItem)
    }
